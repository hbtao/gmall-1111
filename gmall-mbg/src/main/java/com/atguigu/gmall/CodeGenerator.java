...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("H:\\workspace_idea_java\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("hbtao");
        ...
        dsc.setUrl("jdbc:mysql://192.168.32.134:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
